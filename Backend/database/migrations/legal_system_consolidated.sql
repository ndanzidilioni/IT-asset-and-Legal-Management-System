-- ============================================
-- LEGAL MANAGEMENT SYSTEM - CONSOLIDATED DATABASE
-- All Legal Microservices Merged into Single Database
-- Database: scheduling_management_system
-- ============================================
...
CREATE TABLE IF NOT EXISTS `legal_clients` (
  ...
  CONSTRAINT `fk_clients_lawyer` FOREIGN KEY (`assigned_lawyer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_clients_created` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
CREATE TABLE IF NOT EXISTS `legal_cases` (
  ...
  CONSTRAINT `fk_cases_client` FOREIGN KEY (`client_id`) REFERENCES `legal_clients` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_cases_lawyer` FOREIGN KEY (`assigned_lawyer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_cases_created` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `legal_contracts` (
  ...
  CONSTRAINT `fk_contracts_client` FOREIGN KEY (`client_id`) REFERENCES `legal_clients` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_contracts_managed` FOREIGN KEY (`managed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_contracts_created` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `court_schedules` (
  ...
  INDEX `idx_status` (`status`),
  CONSTRAINT `fk_schedules_case` FOREIGN KEY (`case_id`) REFERENCES `legal_cases` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_schedules_lawyer` FOREIGN KEY (`assigned_lawyer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_schedules_created` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `legal_invoices` (
  ...
  INDEX `idx_status` (`status`),
  CONSTRAINT `fk_invoices_client` FOREIGN KEY (`client_id`) REFERENCES `legal_clients` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_invoices_case` FOREIGN KEY (`case_id`) REFERENCES `legal_cases` (`id`) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS `legal_time_entries` (
  ...
  CONSTRAINT `fk_time_case` FOREIGN KEY (`case_id`) REFERENCES `legal_cases` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_time_client` FOREIGN KEY (`client_id`) REFERENCES `legal_clients` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_time_lawyer` FOREIGN KEY (`lawyer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `legal_documents` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_case_id` (`case_id`),
  CONSTRAINT `fk_docs_case` FOREIGN KEY (`case_id`) REFERENCES `legal_cases` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_docs_client` FOREIGN KEY (`client_id`) REFERENCES `legal_clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_docs_contract` FOREIGN KEY (`contract_id`) REFERENCES `legal_contracts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_docs_uploaded` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Success message
SELECT 'Legal Management System - All tables created successfully!' AS status;
